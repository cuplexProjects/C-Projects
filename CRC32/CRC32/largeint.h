...
LARGE_INTEGER WINAPI LargeIntegerDivide (LARGE_INTEGER, LARGE_INTEGER,
PLARGE_INTEGER);
ULONG WINAPI EnlargedUnsignedDivide (ULARGE_INTEGER, ULONG, PULONG);
LARGE_INTEGER WINAPI ExtendedLargeIntegerDivide (LARGE_INTEGER, ULONG,
PULONG);
LARGE_INTEGER WINAPI ExtendedMagicDivide (LARGE_INTEGER, LARGE_INTEGER,
int);
#endif /* __COMPILING_LARGEINT */

#define LargeIntegerAnd(dest, src, m) \
{ \
  dest._STRUCT_NAME(u.)LowPart = s._STRUCT_NAME(u.)LowPart &
m._STRUCT_NAME(u.)LowPart; \
  dest._STRUCT_NAME(u.)HighPart = s._STRUCT_NAME(u.)HighPart &
m._STRUCT_NAME(u.)HighPart; \
}
...
#define LargeIntegerGreaterOrEqualToZero(a) ((a)._STRUCT_NAME(u.)HighPart >
0)
#define LargeIntegerEqualToZero(a) !((a)._STRUCT_NAME(u.)LowPart |
(a)._STRUCT_NAME(u.)HighPart)
#define LargeIntegerNotEqualToZero(a) ((a)._STRUCT_NAME(u.)LowPart |
(a)._STRUCT_NAME(u.)HighPart)
