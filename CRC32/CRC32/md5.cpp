 ...
 */
inline void MD5::MD5_memcpy (POINTER output, POINTER input, unsigned int len)
{
#ifdef USE_memcpyANDMemSet
	...
	for (i = 0; i < len; i++)
		output[i] = input[i];
#endif // USE_memcpyANDMemSet	
}

/*
 * Note: Replace "for loop" with standard memset if possible.
 */
inline void MD5::MD5_memset (POINTER output,int value,unsigned int len)
{
#ifdef USE_memcpyANDMemSet
