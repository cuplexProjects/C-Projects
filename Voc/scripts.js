...
$j(document).ready(function () {
	...
	if (ticketDeflect.size() > 0) {		
		...
		var ticketDeflectBox = $j('<div class="ticket_deflect_box contact_us"><h2><a href="/anonymous_requests/new">Contact Us</a></h2></div>');
...
function showFooterPopup(pageNo) {
	...
	var iFrame = $j('<div class="iframepopup"><div class="modal_iframe_head"><img src="https://cuplex.se/voc/images/popup_close.gif" onclick="$j(\'.modal_bg\').trigger(\'click\');"> </div><div class="iframepopup_bg"></div><iframe src="' + url + '" frameborder="0" scrolling="yes" width="100%" height="100%" seamless></iframe></div>');
...
function showModalImage(imgSrc) {	
	...
	var imgbox = $j('<div class="modal_img"><div class="modal_img_bg"></div><div class="modal_img_head"><img src="https://cuplex.se/voc/images/popup_close.gif" onclick="$j(\'.modal_bg\').trigger(\'click\');"> </div><img src="' + imgSrc + '" class="modal_img_frame"></div>');
