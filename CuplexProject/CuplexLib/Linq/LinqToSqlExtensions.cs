...
namespace CuplexLib.LinqExtensions
{
    public static class LinqToSqlExtensions
    {
        ...
        public static IMultipleResults SelectMultipleResults(this DataContext context, params IQueryable[] queries)
        {
            ...
            //SqlCommand batchCommand = (SqlCommand)context.Connection.CreateCommand();

            //CombineCommands(batchCommand, commandList );
            ...
            dr = batchCommand.ExecuteReader(close ? CommandBehavior.CloseConnection : CommandBehavior.Default);
        ...
        //private static SqlCommand CombineCommands(SqlCommand batchCommand, List<DbCommand> selectCommands )
