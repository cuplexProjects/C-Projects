namespace WebNotes.Controllers
{
    ...
    public sealed class ErrorController : Controller
    {
        ...
        {
            return GetErrorView(HttpStatusCode.BadRequest, ErrorControllerAction.BadRequest);
        }
        ...
        {
            return GetErrorView(HttpStatusCode.Forbidden, ErrorControllerAction.Forbidden);
        }
        ...
        {
            return GetErrorView(HttpStatusCode.InternalServerError, ErrorControllerAction.InternalServerError);
        }
        ...
        {
            return GetErrorView(HttpStatusCode.MethodNotAllowed, ErrorControllerAction.MethodNotAllowed);
        }
        ...
        {
            return GetErrorView(HttpStatusCode.NotFound, ErrorControllerAction.NotFound);
        }
        ...
        {
            return GetErrorView(HttpStatusCode.Unauthorized, ErrorControllerAction.Unauthorized);
        } 
