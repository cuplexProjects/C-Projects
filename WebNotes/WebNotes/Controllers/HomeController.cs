namespace WebNotes.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ContentResult BrowserConfigXml()
        {
            ...
            string content = browserConfigService.GetBrowserConfigXml();
        ...
        public ContentResult ManifestJson()
        {
            Trace.WriteLine(string.Format(
                ...
                Request.Headers.Get("User-Agent")));
            string content = manifestService.GetManifestJson();
        ...
        public ContentResult OpenSearchXml()
        {
            Trace.WriteLine(string.Format(
                ...
                Request.Headers.Get("User-Agent")));
            string content = openSearchService.GetOpenSearchXml();
            return Content(content, ContentType.Xml, Encoding.UTF8);
        }
        ...
        public ContentResult RobotsText()
        {
            Trace.WriteLine(string.Format(
                ...
                Request.Headers.Get("User-Agent")));
            string content = robotsService.GetRobotsText();
