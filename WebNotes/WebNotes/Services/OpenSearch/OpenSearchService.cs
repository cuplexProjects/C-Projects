namespace WebNotes.Services
{
    ...
    public sealed class OpenSearchService : IOpenSearchService
    {
        ...
        public string GetOpenSearchXml()
        {
            ...
            // defined query.
            string searchUrl = _urlHelper.AbsoluteRouteUrl(
            ...
            string searchFormUrl = _urlHelper.AbsoluteRouteUrl(HomeControllerRoute.GetIndex);
            // The link to the favicon.ico file for the site.
            string favicon16Url = _urlHelper.AbsoluteContent("~/content/icons/favicon.ico");
            // The link to the favicon.png file for the site.
            string favicon32Url = _urlHelper.AbsoluteContent("~/content/icons/favicon-32x32.png");
            // The link to the favicon.png file for the site.
            string favicon96Url = _urlHelper.AbsoluteContent("~/content/icons/favicon-96x96.png");
