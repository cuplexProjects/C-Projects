    ...
    public sealed class FeedService : IFeedService
    {
        ...
        public async Task<SyndicationFeed> GetFeed(CancellationToken cancellationToken)
        {
            SyndicationFeed feed = new SyndicationFeed()
            {
                ...
                ImageUrl = new Uri(urlHelper.AbsoluteContent("~/content/icons/atom-logo-96x48.png")),
            ...
            feed.SetIcon(urlHelper.AbsoluteContent("~/content/icons/atom-icon-48x48.png"));
        ...
        private async Task<List<SyndicationItem>> GetItems(CancellationToken cancellationToken)
        {
            ...
            for (int i = 1; i < 4; ++i)
            {
                ...
                item.Links.Add(SyndicationLink.CreateMediaEnclosureLink(
                    new Uri(urlHelper.AbsoluteContent("~/content/icons/atom-icon-48x48.png")), 
                    ContentType.Png, 
                    0));

                // media:thumbnail - Add a Yahoo Media thumbnail for the entry. See http://www.rssboard.org/media-rss 
                //                   for more information.
                item.SetThumbnail(urlHelper.AbsoluteContent("~/content/icons/atom-icon-48x48.png"), 48, 48);
