...
namespace GeneralToolkitLib.Utility.RandomGenerator
{
    public class SecureRandomGenerator
    {
        ...
        {
            _randomNumberGenerator =new RNGCryptoServiceProvider($"r8vuGDGbXnOFa4Av9wZsz9bJYATmYtmD-Ticks:{DateTime.Now.Ticks}- {"nsVK3IAsQy2ccH3KyRHTLo9uxDpEplNO"} - Date:{DateTime.Now.ToString("hh:mm:ss t z")}");
        }
