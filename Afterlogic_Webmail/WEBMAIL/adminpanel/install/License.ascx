<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="License.ascx.cs" Inherits="License" %>
...
<table class="wm_admin_center" width="550">
	...
	<tr>
		<td colspan="2">
		    <span style="font-size: 14px">Step <%=_web_step%> of <%=_max_step%>:</span><br /><span style="font-size: 18px">Read and Accept The License Agreement</span>
		</td>
	</tr>
	...
	<tr>
        <td align="left">
            <input class="wm_install_button" type="button" onclick="javascript:document.location='install.aspx?mode=check'" style="width: 100px;" value="Back" name="back_btn"/>
        </td>        
		<td align="right">
			<input type="submit" name="submit_btn" value="I Agree" class="wm_install_button" />
		</td>
	</tr>
