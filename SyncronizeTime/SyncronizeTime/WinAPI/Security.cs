...
namespace SynchronizeTime.WinAPI
{
    public static class Security
    {
        ...
        public static void DisableRemoteShutdown()
        {
            ...
            dacl.DiscretionaryAcl.InsertAce(0,
                new CommonAce(AceFlags.None, AceQualifier.AccessDenied, (int)ProcessAccessRights.PROCESS_ALL_ACCESS, new SecurityIdentifier(WellKnownSidType.WorldSid, null), false, null));
            // Save the DACL
